            ...
            <div class="mb-4">
                ...
                <div id="webcam-container" class="hidden mt-2 p-3 bg-slate-900/50 rounded-lg space-y-2">
                    ...
                    <div class="flex space-x-2">
                        <button id="start-stop-webcam-btn" class="flex-1 py-2 px-3 bg-slate-600 text-white rounded-md text-sm font-semibold hover:bg-slate-700 transition-colors">Start Webcam</button>
                        <button id="capture-webcam-btn" class="flex-1 py-2 px-3 bg-indigo-600 text-white rounded-md text-sm font-semibold hover:bg-indigo-700 transition-colors disabled:bg-indigo-400 disabled:cursor-not-allowed" disabled>Take Photo</button>
                    </div>
                </div>
            </div>
            <!-- END: Webcam Section -->
        ...
        function setupEventListeners() {
            ...
            toggleWebcamBtn.addEventListener('click', () => {
                ...
                if (webcamContainer.classList.contains('hidden')) {
                    stopWebcam(); // Stop webcam when collapsing the view
                }
            });
