...
- All user-submitted content, including files and images, are processed ephemerally (in memory). At no time is any data copied or stored on disk.
...
In other words, myOfflineAi is a helpful interface running in your browser. Ollama models do the thinking in the background. Everything happens locally - your sensitive data never leaves your computer.
